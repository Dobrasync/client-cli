...
using Lamashare.CLI.ApiGen.Clients;

namespace Lamashare.CLI.ApiGen;
...
public static class Registrations
{
    ...
    {
        public const string Auth = "LamashareCLIApiGenAuthClient";
        public const string File = "LamashareCLIApiGenFileClient";
        public const string Library = "LamashareCLIApiGenLibraryClient";
        public const string User = "LamashareCLIApiGenUserClient";
    }
    ...
    public static IServiceCollection RegisterApiClients(this IServiceCollection services, ApiRegistration registration)
    {
        ...
        Register<IAuthClient, AuthClient>(__ClientNames.Auth);
        Register<IFileClient, FileClient>(__ClientNames.File);
        Register<ILibraryClient, LibraryClient>(__ClientNames.Library);
        Register<IUserClient, UserClient>(__ClientNames.User);
