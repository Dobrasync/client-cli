...
public sealed class AuthDto : __ICanIterate
{
    [System.Text.Json.Serialization.JsonConstructor] public AuthDto() { }

    public AuthDto(System.DateTime expiresUtc)
    {
	...
	{
		yield return ("authToken", AuthToken);
		yield return ("expiresUtc", ExpiresUtc);
	}
}
