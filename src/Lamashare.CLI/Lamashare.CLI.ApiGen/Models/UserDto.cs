...
public sealed class UserDto : __ICanIterate
{
    [System.Text.Json.Serialization.JsonConstructor] public UserDto() { }

    public UserDto(System.Guid id)
    {
        Id = id;
    }
	...
	public System.Collections.Generic.List<string>? LibraryIds { get; set; }
	...
	System.Collections.Generic.IEnumerable<(string name, object? value)> __ICanIterate.IterateProperties()
	{
		...
		yield return ("libraryIds", LibraryIds);
	}
}
