...
public sealed class FileStatusDto : __ICanIterate
{
    [System.Text.Json.Serialization.JsonConstructor] public FileStatusDto() { }

    public FileStatusDto(bool isLocked)
    {
        IsLocked = isLocked;
    }
	...
	{
		yield return ("isLocked", IsLocked);
	}
}
