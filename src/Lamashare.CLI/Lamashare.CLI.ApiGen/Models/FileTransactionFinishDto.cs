...
public sealed class FileTransactionFinishDto : __ICanIterate
{
    [System.Text.Json.Serialization.JsonConstructor] public FileTransactionFinishDto() { }

    public FileTransactionFinishDto(bool success)
    {
        Success = success;
    }
