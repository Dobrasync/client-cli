...
public sealed class LibraryDtoPaging : __ICanIterate
{
    [System.Text.Json.Serialization.JsonConstructor] public LibraryDtoPaging() { }

    public LibraryDtoPaging(int count)
    {
        Count = count;
    }

	public int Count { get; set; }
	public System.Collections.Generic.List<LibraryDto>? Data { get; set; }
