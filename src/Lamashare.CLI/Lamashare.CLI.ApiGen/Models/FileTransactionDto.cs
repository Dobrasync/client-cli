...
public sealed class FileTransactionDto : __ICanIterate
{
    [System.Text.Json.Serialization.JsonConstructor] public FileTransactionDto() { }

    public FileTransactionDto(System.Guid transactionId, System.Guid fileId, EFileTransactionType type)
    {
	...
	{
		yield return ("transactionId", TransactionId);
